...
latex_documents = [
  ('index', 'libuvAPIdocumentation.tex', u'libuv API documentation',
...
man_pages = [
    ('index', 'libuvapidocumentation', u'libuv API documentation',
...
texinfo_documents = [
  ('index', 'libuvAPIdocumentation', u'libuv API documentation',
   u'libuv contributors', 'libuvAPIdocumentation', 'Cross-platform asychronous I/O',
   'Miscellaneous'),
]
