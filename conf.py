...
copyright = u'2014, libuv contributors'
...
htmlhelp_basename = 'libuvAPIdocumentationdoc'
...
latex_documents = [
  ('index', 'libuvAPIdocumentation.tex', u'libuv API documentation Documentation',
...
man_pages = [
    ('index', 'libuvapidocumentation', u'libuv API documentation Documentation',
...
texinfo_documents = [
  ('index', 'libuvAPIdocumentation', u'libuv API documentation Documentation',
   u'libuv contributors', 'libuvAPIdocumentation', 'One line description of project.',
   'Miscellaneous'),
]
...
#epub_basename = u'libuv API documentation'
